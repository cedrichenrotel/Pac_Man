...
class Pathfinding():
    ...
    def can_move(self, direction: str, pos: tuple, visited: list) -> bool:
    ...
    def move(self, direction: str, pos: tuple) -> tuple:
    ...
    def get_free_paths(self, pos: tuple, visited: list) -> list:
    ...
    def return_where_possibility(self, pos: tuple,
                                 visited: list) -> (tuple, tuple):
    ...
    def check_neighbour(self, pos: tuple,
                        visited: list, real_path: list) -> (tuple, str):
    ...
    def select_way(self, pos: tuple, visited: list, real_path: list) -> tuple:
    ...
    def bfs(self, pos_pacman: tuple, pos_ghost: tuple) -> list:
        ...
        while actual_pos != pos_pacman:
            actual_pos = self.select_way(actual_pos, visited, real_path)
